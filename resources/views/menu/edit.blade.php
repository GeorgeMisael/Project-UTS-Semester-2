...
<div class="card-body">
  ...
  <form action="{{ route('menu.update', $menu->id) }}" method="post" class="forms-sample">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="{{ $menu->judul }}">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" name="link" class="form-control" id="link" placeholder="link" value="{{ $menu->link }}">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" name="create_by" class="form-control" id="create_by" placeholder="create_by" value="{{ $menu->create_by }}">
      </div>
    </div>
